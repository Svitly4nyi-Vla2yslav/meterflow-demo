...
export function DashboardPage() {
  ...
  return <div className="page-stack"><section className="page-intro"><div><p className="eyebrow">Portfolioübersicht</p><h2>Guten Morgen, Vladyslav</h2><p>Alle Mieterstrom-Projekte und nächsten Schritte auf einen Blick.</p></div><Link className="button" to="/projects/new"><Plus /> Neues Projekt</Link></section>
